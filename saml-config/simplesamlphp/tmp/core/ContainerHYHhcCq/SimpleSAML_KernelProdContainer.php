...
class SimpleSAML_KernelProdContainer extends Container
{
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ??= new \Symfony\Component\Routing\RequestContext()), ($container->privates['logger'] ?? self::getLoggerService($container)), (\dirname(__DIR__, 4).'/vendor/simplesamlphp/simplesamlphp'), false);
    }
    ...
    {
        return [
            'kernel.project_dir' => (\dirname(__DIR__, 4).'/vendor/simplesamlphp/simplesamlphp'),
            ...
            'kernel.secret' => 'defaultsecretfordevonly-changeinproduction',

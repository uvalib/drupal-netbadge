 ...
 */
$metadata['https://drupal-dhportal.ddev.site:8443'] = [
    'AssertionConsumerService' => [
        [
            'index' => 1,
            'isDefault' => true,
            'Location' => 'https://drupal-dhportal.ddev.site:8443/simplesaml/module.php/saml/sp/saml2-acs.php/default-sp',
            'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',
        ],
    ],
    'SingleLogoutService' => [
        [
            'Location' => 'https://drupal-dhportal.ddev.site:8443/simplesaml/module.php/saml/sp/saml2-logout.php/default-sp',
